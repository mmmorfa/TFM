...
class SliceCreationEnv5(gym.Env):
    ...
    def __init__(self, render_mode=None, size=5):
        ...
        #self.resources = [1000]
        self.resources_1 = {'MEC_CPU': 128, 'MEC_RAM': 512, 'MEC_STORAGE': 5000, 'MEC_BW': 2000}
        self.resources_2 = {'MEC_CPU': 128, 'MEC_RAM': 512, 'MEC_STORAGE': 5000, 'MEC_BW': 2000}
        self.resources_3 = {'MEC_CPU': 128, 'MEC_RAM': 512, 'MEC_STORAGE': 5000, 'MEC_BW': 2000}
        self.resources_4 = {'MEC_CPU': 128, 'MEC_RAM': 512, 'MEC_STORAGE': 5000, 'MEC_BW': 2000}
        self.resources_5 = {'MEC_CPU': 64, 'MEC_RAM': 256, 'MEC_STORAGE': 2000, 'MEC_BW': 1000}
        self.resources_6 = {'MEC_CPU': 64, 'MEC_RAM': 256, 'MEC_STORAGE': 2000, 'MEC_BW': 1000}
    ...
    def reset_resources(self):
        ...
        self.resources_1['MEC_CPU'] = 128
        self.resources_1['MEC_RAM'] = 512
        self.resources_1['MEC_STORAGE'] = 5000
        self.resources_1['MEC_BW'] = 2000
        self.update_db('resources', 1)

        self.resources_2['MEC_CPU'] = 128
        self.resources_2['MEC_RAM'] = 512
        self.resources_2['MEC_STORAGE'] = 5000
        self.resources_2['MEC_BW'] = 2000
        self.update_db('resources', 2)

        self.resources_3['MEC_CPU'] = 128
        self.resources_3['MEC_RAM'] = 512
        self.resources_3['MEC_STORAGE'] = 5000
        self.resources_3['MEC_BW'] = 2000
        self.update_db('resources', 3)

        self.resources_4['MEC_CPU'] = 128
        self.resources_4['MEC_RAM'] = 512
        self.resources_4['MEC_STORAGE'] = 5000
        self.resources_4['MEC_BW'] = 2000
        self.update_db('resources', 4)

        self.resources_5['MEC_CPU'] = 64
        self.resources_5['MEC_RAM'] = 256
        self.resources_5['MEC_STORAGE'] = 2000
        self.resources_5['MEC_BW'] = 1000
        self.update_db('resources', 5)

        self.resources_6['MEC_CPU'] = 64
        self.resources_6['MEC_RAM'] = 256
        self.resources_6['MEC_STORAGE'] = 2000
        self.resources_6['MEC_BW'] = 1000
        self.update_db('resources', 6)
